...
write.csv(DC_Info,"DC_Info_20230502.csv",row.names = FALSE)
...
write.csv(DC_Info_F,"DC_Info_F_20230502.csv",row.names = FALSE)
...
write.csv(DC_Info_Group,"DC_Info_Group_20230502.csv",row.names = FALSE)
...
#write csv
write.csv(DC_ClosestWeight,"DC_ClosestWeight_20230502.csv",row.names = FALSE)
...
write.csv(DC_Info_Urine_F,"DC_Info_Urine_F_20230205.csv",row.names = FALSE)
