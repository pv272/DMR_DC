...
Are age and BM correlated? Does the correlation vary with breeding status 
...
ggplot(AgeBM_Data, aes(x = Age, y = Weight, color = BS_Original)) +
  geom_point() +
...
ggstatsplot::ggscatterstats(
  ...
  marginal = FALSE, # to not show the marginal distributions
  point.args = list(alpha = 0.7, size = 3),
  smooth.args = list(method = "lm", formula = y ~ x),
  ggplot.component = list(
    geom_smooth(method = "lm", aes(group = Treatment, linetype = Treatment), se = FALSE),
    theme_minimal()
  )
)
