...
DC_Info_F <- read.csv("DC_Info_F_20231101.csv") %>% 
...
#Relevant weight
DC_ClosestWeight <- read.csv("DC_ClosestWeight_20231101.csv")
names()


#Urine info 
#check what info is there
DC_Info_Urine_F_20231106.csv
...
There are 12 groups where the evictor evicted quickly around conception. 
9x in Sub treatment
...
There are 3 groups where evictor evicted pre-first successful conception 
...
To check whether female may have died during labour. I know there is one such group in the exeriment
