...
#write csv
write.csv(DC_Info_F,"DC_Info_F_20240710.csv",row.names = FALSE)
...
write.csv(SamplingCat, "SamplingCat_20240710.csv", row.names = FALSE)
...
write.csv(DC_Info_Urine_F,"DC_Info_Urine_F_20240710.csv",row.names = FALSE)
