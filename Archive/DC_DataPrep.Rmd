...
DC_Info <- 
  ...
  mutate(ExperimentalUnit = match(ExperimentalGroup, unique(ExperimentalGroup))) %>%
...
DC_Info_F <- DC_Info %>% 
  ...
  mutate(PlotCategory = fct_relevel(BS_PlotCategory, "Sub_S", "Sub_Q", "Breeder"))
