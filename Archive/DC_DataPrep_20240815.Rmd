...
write.csv(DC_Info,"DC_Info_20240710.csv",row.names = FALSE)
...
#There are 76 entries in DC info
#We should have 75 entries 3x25
...
write.csv(DC_Info_Group,"DC_Info_Group_20240710.csv",row.names = FALSE)
...
#write csv
write.csv(DC_ClosestWeight,"DC_ClosestWeight_20240710.csv",row.names = FALSE)
