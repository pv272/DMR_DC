...
DC_Info_Urine <- DC_Info %>%
  ...
  left_join(.,DC_NextParturition_F %>% 
              ...
              select(AnimalID,
                     ...
                     NextParturition_ParturitionColony), by=c("AnimalID" = "AnimalID",
                                                 "UrineDate" = "Date")) %>% 
...
write.csv(DC_Info_Urine_F,"DC_Info_Urine_F_20240206.csv",row.names = FALSE)
