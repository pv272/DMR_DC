...
Ultimately, I should re-run the code and make a Rda out of this file
...
setwd(Dir_DCRda)
save(DC_Info_F,file = "DC_Info_F.rda")
...
setwd(Dir_DCRda)
save(DC_Info_Group,file = "DC_Info_Group.rda")
...
setwd(Dir_DCRda)
save(DC_Urine_F,file = "DC_Urine_F.rda")
...
```{r DC Closest Weight Rda}

setwd(Dir_DCRda)
save(DC_ClosestWeight,file = "DC_ClosestWeight.rda")
...
```{r DC_Info_Urine_F Rda}

setwd(Dir_DCRda)
save(DC_Info_Urine_F,file = "DC_Info_Urine_F.rda")
